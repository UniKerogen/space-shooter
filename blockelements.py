...
player_armory.append(name='bullet3',
                     ...
                     contact=[[29, 0], [31, 0]],
                     active=False,
                     image=pygame.image.load('resources/player/bullet3.png'),
...
player_armory.append(name='bullet4',
                     ...
                     contact=[[17, 16], [19, 16]],
                     active=False,
                     image=pygame.image.load('resources/player/bullet4.png'),
...
player_armory.append(name='bullet5',
                     ...
                     contact=[[7, 28], [9, 28]],
                     active=False,
                     image=pygame.image.load('resources/player/bullet5.png'),
                     cooldown=[BULLET_COOLDOWN_BASE * 1.2, BULLET_COOLDOWN_BASE * 1.2],
                     damage=45
                     )
player_armory.append(name='bullet6',
                     ...
                     contact=[[1, 40], [3, 40]],
                     active=False,
                     image=pygame.image.load('resources/player/bullet6.png'),
                     cooldown=[BULLET_COOLDOWN_BASE * 1.2, BULLET_COOLDOWN_BASE * 1.2],
                     damage=55
                     )
